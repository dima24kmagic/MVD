...
function createdoc(name, object, inventory) {
  ...
  // doc.addParagraph(paragraph)
  doc
    .createParagraph('охранно- тревожной сигнализации ')
    .style('UnderLine')
    .center()
  // doc.addParagraph(paragraph)
  ...
  // doc.addParagraph(paragraph);
  doc
    .createParagraph('Комиссия в составе:\n ')
    .style('Heading1')
    .left()
  doc
    .createParagraph(
  ...
  if (!isResultsFolderExist) fs.mkdirSync(`./${DOCX_RESULTS_FOLDER_NAME}`)
